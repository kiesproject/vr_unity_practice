...
public class DangeonGenerator : MonoBehaviour
{
    ...
    // 部屋の数や大きさを指定
    [SerializeField] int roomMinHeight = 5;
    [SerializeField] int roomMaxHeight = 10;

    [SerializeField] int roomMinWidth = 5;
    [SerializeField] int roomMaxWidth = 10;

    [SerializeField] int RoomCountMin = 10;
    [SerializeField] int RoomCountMax = 15;

    // 道の集合点の数
    [SerializeField] int meetPointCount = 1;
